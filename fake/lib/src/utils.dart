...
Future<td.Message> getMessage(String fileName) async {
  final String rawJson = await rootBundle.loadString('packages/fake/assets/messages/$fileName.json');
...
Future<td.User> getUser(String fileName) async {
  final String rawJson = await rootBundle.loadString('packages/fake/assets/users/$fileName.json');
