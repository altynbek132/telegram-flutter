...
class ChatHeightProvider extends StatefulWidget {
  ...
  static double getValue(BuildContext context) {
    final CellHeightModel? heightModel = InheritedModel.inheritFrom<CellHeightModel>(context);
...
class _ChatHeightProviderState extends State<ChatHeightProvider> {
  ...
  void didChangeDependencies() {
    ...
    final ChatCellTheme chatCellTheme = Theme.of(context).extension<ChatCellTheme>()!;
    ...
    final double secondarySubtitleHeight = _calculateHeight(chatCellTheme.secondarySubtitleStyle);
