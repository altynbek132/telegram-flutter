...
class SharedMediaFeature implements ISharedMediaFeatureApi {
  SharedMediaFeature({required SharedMediaFeatureDependencies dependencies}) : _dependencies = dependencies;

  final SharedMediaFeatureDependencies _dependencies;

  @override
  late final ISharedMediaScreenFactory sharedMediaScreenFactory = SharedMediaScreenFactory(dependencies: _dependencies);
}
