...
class ProfileFeature implements IProfileFeatureApi {
  ProfileFeature({required ProfileFeatureDependencies dependencies}) : _dependencies = dependencies;

  final ProfileFeatureDependencies _dependencies;

  @override
  late final IProfileScreenFactory profileScreenFactory = ProfileScreenFactory(dependencies: _dependencies);
}
